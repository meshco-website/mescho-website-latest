...
export const products: Product[] = [
  ...
  },
  {
    ...
    image: '/products/Wire/black-annealed-wire/meshco-black-annealed-binding-wire-1.webp',
  ...
  },
  {
    ...
    image: '/products/Wire/pvc-coated-wire/meshco-green-pvc-wire-5kg.webp',
  ...
  },
  {
    ...
    image: '/products/Wire/straight-and-cut-wire/meshco-straight-and-cut-galvanised-wire.webp',
...
const productDetailData: Record<string, ProductDetail> = {
  'wire-hard-drawn-wire': {
    ...
    tabs: [
      ...
      },
      {
        ...
        label: 'Applications',
        content: [],
        html: `<p>Hard drawn wire is a staple across industries where strength, stiffness, and cost-efficiency matter.<br>Common applications include:</p><ul><li>Reinforcing components in <strong>welded mesh</strong> and <strong>precast concrete</strong></li><li><strong>Shutter wire</strong> and <strong>formwork bracing</strong> in construction</li><li><strong>Hanger wire, binding wire,</strong> and <strong>structural supports</strong></li><li>Manufacture of <strong>straight and cut wire, wall ties, nails,</strong> and other fasteners</li><li>Use in <strong>agriculture</strong> and <strong>general purpose straining</strong></li></ul>`,
      },
      {
        id: 'advantages',
        label: 'Advantages',
        content: [],
        html: `<ul><li><strong>Higher tensile strength</strong> than annealed wire for improved rigidity and load-bearing</li><li><strong>Cost-effective</strong> solution for structural and industrial use</li><li><strong>Excellent dimensional consistency</strong> and surface finish</li><li>Drawn in-house under strict quality control to ensure reliability</li></ul>`,
      },
      {
        id: 'customisation',
        label: 'Customisation',
        content: [],
        html: `<ul><li>Available in various coil weights and internal diameters to suit automated processing</li><li>Can be straightened and cut to custom lengths upon request</li><li>Bulk supply options available for high-volume customers</li></ul><p><strong>Made strong. Made local. Made to matter.</strong></p><p>Meshco's hard drawn wire is the foundation behind countless infrastructure and industrial projects across Southern Africa. Whether you're building, binding, or reinforcing; we supply the wire that delivers uncompromising performance every time.</p>`,
      },
    ],
    relatedProductKeys: [
  ...
  'wire-black-annealed-wire': {
    ...
    tabs: [
      ...
      },
      {
        ...
        content: [],
        html: `<p>The quantity of black annealed tying wire required to secure reinforcement bars (rebar) on a construction site in South Africa depends on the diameter of the rebar being tied. The required amount can vary based on tying method, bar spacing, and site specifics. A general guideline is:</p><p><strong>Most projects:</strong> Plan for 9–13 kg of black annealed tying wire per ton of rebar, adjusting based on actual bar diameters and tying practices</p><p><strong>Smaller diameter rebar:</strong> Use the higher end of the range (up to 12–13 kg per ton).</p><p><strong>Larger diameter rebar:</strong> Use the lower end of the range (as little as 7 kg per ton).</p><p>For precise requirements, consult your rebar supplier or site engineer, as local practices and project specifics may affect the total quantity needed.</p>`,
      },
    ],
    relatedProductKeys: [
    ...
    tabs: [
      ...
      },
      {
        ...
        content: [
          ...
          'Reliable. Customisable. Manufactured to Last.:',
          "Meshco's straight and cut wire gives you the confidence of strength with the flexibility to suit your requirement. Whether you need high-volume runs or small-batch precision lengths, our team is here to deliver wire that's manufactured to matter.",
        ],
      },
    ],
    relatedProductKeys: [
  ...
  'reinforcing-brickforce': {
    ...
    layoutType: 'standard',
    images: ['/products/Reinforcing/brick-force/meshco-brickforce-galvanised.webp'],
    specifications: [
  ...
  'reinforcing-hoop-iron': {
    ...
    layoutType: 'standard',
    images: ['/products/Reinforcing/hoop-iron/meshco-hoop-iron.webp'],
    specifications: [],
    applications: [
      'Roof truss bracing',
  ...
  'reinforcing-cavity-wall-ties': {
    ...
    layoutType: 'standard',
    images: [
      '/products/Reinforcing/cavity-wall-ties/meshco-butterfly-wall-tie-1.webp',
    ...
    tabs: [
      ...
      },
      {
        ...
        label: 'Pro-Tip',
        content: [],
        html: `<p><strong>How many wall ties to use?</strong></p><p>As a rule of thumb, 2.5 wall ties per square meter is the standard density for masonry cavity walls, with the following specifics:</p><p><strong>Spacing:</strong><br>Horizontal: 900mm maximum.<br>Vertical: 450mm maximum.</p><p><strong>Distribution:</strong><br>Ties should be evenly staggered across the wall, except around openings (e.g., windows, doors), where they are spaced every 300mm vertically and within 225mm of the edge.</p><p>For timber frame walls, the density increases:<br>4.4 ties/m² for basic wind speeds ≤25m/s.</p><p>7 ties/m² in high-wind areas.</p><p><strong>Key exceptions:</strong><br>Insulated cavities: Ties may need closer spacing (e.g., 600mm horizontally) to secure insulation boards.<br>Remedial work: Follow the same 2.5 ties/m² guideline unless specified otherwise.</p><p><strong>Note:</strong> This assumes standard masonry walls with both leaves (walls) ≥90mm thick. Always confirm spacing with local building codes or structural engineers for atypical designs.</p>`,
      },
    ],
    relatedProductKeys: [
      { key: 'reinforcing-brickforce', displayTitle: 'Galvanised Brickforce Standard' },
  ...
  'fencing-hexagonal-netting': {
    ...
    layoutType: 'simple',
    images: ['/products/Fencing/hexagonal-wire-netting/meshco-hexagonal-netting-galvanised.webp'],
    specifications: [],
    applications: [
  ...
  'fasteners-round-wire-nails': {
    ...
    layoutType: 'standard',
    images: ['/products/Fasteners/round-wire-nails/meshco-round-wire-nail.webp'],
    specifications: [
      {
        label: 'Available Sizes',
        value:
